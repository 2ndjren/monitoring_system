...
@section('coordinators')
                ...
                <div class="modal-body">
                    <form id="addForm">
                        <div class="form-floating mb-3">
                            <input type="text" name="co_fname" class="form-control">
                            <label for="floatingInput">First Name</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" name="co_lname" class="form-control">
                            <label for="floatingInput">Last Name</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" name="co_phone" class="form-control">
    ...
    <script src="{{ asset('js/coordinators.js') }}"></script>
@endsection
